...
DHTxx   &\PBS\centering Two\+Wire   &\PBS\centering Auto   &\PBS\centering DEPRECATED   \\\cline{1-4}
\end{longtabu}
...
\DoxyCodeLine{sensors.\mbox{\hyperlink{classSensors_a019efdf3e65081e9ace94e1f05338e4b}{init}}();                               \textcolor{comment}{// start all sensors and}}
...
\DoxyCodeLine{    sensors.\mbox{\hyperlink{classSensors_a019efdf3e65081e9ace94e1f05338e4b}{init}}();                                 \textcolor{comment}{// Auto detection to UART and i2c sensors}}
\DoxyCodeLine{}
...
\doxysubsection*{Output}

On your serial monitor you should have something like that\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{-\/-\/>[SETUP] Detecting sensors..}
\DoxyCodeLine{-\/-\/>[SETUP] Sensor configured: SENSIRION}
\DoxyCodeLine{-\/-\/>[MAIN] PM1.0: 002 PM2.5: 004 PM10: 006}
\DoxyCodeLine{-\/-\/>[MAIN] PM1.0: 002 PM2.5: 002 PM10: 002}
\DoxyCodeLine{-\/-\/>[MAIN] PM1.0: 002 PM2.5: 002 PM10: 002}
...
Also you could define a custom UART pins in the init() method if it isn\textquotesingle{}t autodected\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{sensors.\mbox{\hyperlink{classSensors_a019efdf3e65081e9ace94e1f05338e4b}{init}}(sensors.Auto,RX,TX); \textcolor{comment}{// custom RX, custom TX pines.}}
...
Thanks to all collaborators and \href{https://canair.io}{\texttt{ Can\+Air\+IO}} community for testing and reports.
